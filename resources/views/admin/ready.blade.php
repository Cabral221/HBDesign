...
@section('content')
    <div class="container pt-3 pb-3">
        ...
        <div class="row justify-content-center">
            <div class="col-12 alert alert-info text-center"><h2>Commandes déja etudiées ({{ $commandes->total() }})</h2></div>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-10">
                        ...
                        <tbody>
                            @foreach ($commandes as $c)
                                <tr>
                                    ...
                                    <td>{{ $c->amount }}</td>
                                    <td>
                                        <div><a href="{{ route('admin.product.show',$c->id) }}">Visualiser</a></div>
                                        <div><a href="{{ route('admin.product.handledeleted', $c->id) }}">rejeter</a></div>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
