...
@section('content')
    <div class="container pt-3 pb-3">
        ...
        <div class="row justify-content-center">
            <div class="col-12 alert alert-info  text-center"><h2>Toutes les commandes reçues ({{ $commandes->total() }})</h2></div>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-10">
                            ...
                            @foreach ($commandes as $c)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif($c->stat == true)
                                            <span class="badge badge-pill badge-primary">Regler</span>
                                        @elseif($c->stat == false)
